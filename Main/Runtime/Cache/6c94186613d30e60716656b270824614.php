    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['日期', '销量'],
        <?php echo ($googleChart); ?>
        ]);

        var options = {
          title: '2013年双十一销量走势图',
          hAxis: {title: '2013年10月30日 - 2013年11月11日', titleTextStyle: {color: 'red'}}
        };
