...
<div class="row-fluid">
<form name="search" action="__APP__/Order/index" method="GET">
<div class="span12">
<!-- 加入过滤项 -->
过滤：
<?php if(is_array($statusList)): $k = 0; $__LIST__ = $statusList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$status): $mod = ($k % 2 );++$k;?><span class="label <?php echo (getorderstatuslabel($k-1)); ?> label-mini"><a href="__URL__/index/status/<?php echo ($k-1); ?>"><?php echo ($status); ?></a></span> &nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
...
<input type="hidden" value="/Order/index" name="s" />
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-shopping-cart"></i><?php echo ($title_h2); ?></div>
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-bordered table-advance table-hover">
									...
									<thead>
										...
										<tr>
											...
											<th><i class="icon-briefcase"></i> 订单号</th>

											<th class="hidden-phone"><i class="icon-user"></i> 姓名</th>

											<th><i class="icon-phone"></i> 电话</th>
											<th>卡号</th>
											<th>订单时间</th>
											<th><i class="icon-stat"></i> 状态</th>
											<th></th>
									...
									<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
											...
											<td><a href="__APP__/Order/edit"><?php echo ($item["id"]); ?></a></td>

											<td class="hidden-phone"><?php echo ($item["name"]); ?></td>

											<td><?php echo ($item["mobile"]); ?></td>
											<td><?php echo ($item["card"]); ?></td>
											<td><?php echo ($item["tmall_create_time"]); ?></td>
											<td><span class="label <?php echo (getorderstatuslabel($item["status"])); ?> label-mini"><?php echo (getorderstatus($item["status"])); ?></span></td>
											<td><a href="__APP__/Order/edit&id=<?php echo ($item["id"]); ?>" class="btn mini green-stripe">View</a></td>
								...
								<div class="row-fluid" style="display:none;"><div class="span3"><div class="dataTables_info" id="sample_1_info">显示  1到5条 </div></div><div class="span6"><div class="dataTables_paginate paging_bootstrap pagination"><ul><li class="prev disabled"><a href="#">← <span class="hidden-480">上一页</span></a></li><li class="active"><a href="#">1</a></li><li><a href="#">2</a></li><li><a href="#">3</a></li><li><a href="#">4</a></li><li><a href="#">5</a></li><li class="next"><a href="#"><span class="hidden-480">下一页</span> → </a></li></ul></div></div></div>
